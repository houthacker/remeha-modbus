...
async def get_repairs(hass: HomeAssistant, hass_ws_client: WebSocketGenerator):
...
async def start_repair_fix_flow(client: TestClient, handler: str, issue_id: str) -> dict[str, Any]:
    """Start a repair flow from an issue."""
...
async def process_repair_fix_flow(
    ...
    assert RepairsFlowResourceView.url is not None
